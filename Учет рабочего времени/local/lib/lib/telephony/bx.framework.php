...
function bx_auth($type=2)
{
	...
	if ($type == 3)
	{
		...
		if(isset($_GET['code']) or isset($_POST['code']))
		{
            ...
            $maxTry = 10;
            $try = 1;
            while ( empty($access_array["access_token"]) && $try <= $maxTry ) {
                ++$try;
    ...
    elseif ($type == 4)
    {
    	...
    	$post['AUTH_FORM'] = "Y";
    	$post['TYPE'] = "AUTH";
    	/* -----> */ $post['backurl'] = "/oauth/authorize/?user_lang=ua&client_id=b24.538a2982889106.40457798&redirect_uri=http%3A%2F%2Filevel.bitrix24.ua%2Foauth%2Fauthorize%2F%3Fauth_service_id%3DBitrix24Net%26oauth_proxy_params%3DcmVkaXJlY3RfdXJpPWh0dHAlM0ElMkYlMkZpbGV2ZWwud3MlMkZjcm0lMkZhcHAucGhwJmNsaWVudF9pZD1iOTllNWRjNDMyNzM4ZTBkZTAzMGI3OTFlYzMzNjFhNiZyZXNwb25zZV90eXBlPWNvZGU%253D&scope=auth%2Cprofile&response_type=code&state=site_id%3Ds1%26backurl%3D%252Foauth%252Fauthorize%252F%253Fcheck_key%253D3fa0356da91793514f8f3ffe68dadce6%2526client_id%253Db99e5dc432738e0de030b791ec3361a6%2526response_type%253Dcode%2526redirect_uri%253Dhttp%25253A%25252F%25252Filevel.ws%25252Fcrm%25252Fapp.php%26mode%3Dpage";
